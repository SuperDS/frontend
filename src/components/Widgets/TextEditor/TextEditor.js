  ...
  return (
    <div className="TextEditor">
      ...
      <div className="Textbox">
        <button onClick={textOnclick}>수정</button>
          ...
          {textsetup ? (
            <CKEditor
              ...
              config={{
                ...
                heading: {
                  options: [
                      { model: 'paragraph', title: '보통', class: 'ck-heading_paragraph' },
                      { model: 'heading1', view: 'h1', title: '기본크기', class: 'ck-heading_heading1' },
                      { model: 'heading3', view: 'h5', title: '제목', class: 'ck-heading_heading2' }
                  ]
              }
              }}
